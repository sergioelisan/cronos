...
import edu.cronos.gui.custom.Dialog;
...
public class CadastroLaboratorios extends javax.swing.JPanel {
    ...
    private void load() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    laboratorios = CronosAPI.get(Laboratorio.class);
    ...
    private void show(final String code) {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Laboratorio lab = CronosAPI.get(Laboratorio.class, Integer.parseInt(code));
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, txtdescricao, txtnome);
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, txtdescricao, txtnome);
